        ...
        <div class="">
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <a class="navbar-brand text-white clean" href="index.php">Navbar</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="item">
                            ...
                            <li class="dash"><a href="contact.php" class="clean">Contact</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
        ...
        <div class="overflow">
            <div class="pt-5 pb-5 alldetails">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="">
                                <img src="img/new(11).jpg" alt="" width="100%">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="linee">
                                ...
                                <div class="ps-2">
                                    ...
                                    <ul class="mt-5 damo">
                                        <li class="mail">Email: email@example.com</li>
                                        <li class="mb-4">Phone: (555) 555-5555</li>
                                        <li>123 Damo Street </li>
                                        <li class="mb-4">New York NY 12345</li>
                                        <li>
                                            <div class="soc mb-4">
            ...
            <div class="footer pt-5">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing <br>
                                elit. Obcaecati eum perspiciatis, laborum ullam iusto <br>
                                sapiente quisquam harum fugit accusantium illo.
                            </p>
                    ...
                    <center><span>© 2023 EmmyTech</span></center>
                </div>
            </div>
        </div>
    </div>
